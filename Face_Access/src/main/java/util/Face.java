...
public class Face {
    private static final String APP_ID = "11368491";
    private static final String API_KEY = "ny80bPXaYSIEGAVi3j7qGAKt";
    private static final String SECRET_KEY = "fAI5QNavqcyXVEGm35kzrfFThxpt41wg";
...
//                map.put("liveness_control", "NORMAL");
            ...
            String param = GsonUtils.toJson(map);
            // 注意这里仅为了简化编码每一次请求都去获取access_token，线上环境access_token有过期时间， 客户端可自行缓存，过期后重新获取。
            String accessToken = Face.getAuth();
            String result = HttpUtil.post(url, accessToken, "application/json", param);
            System.out.println(result);
            return result;
        } catch (Exception e) {
